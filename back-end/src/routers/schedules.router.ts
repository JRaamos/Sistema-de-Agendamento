...
routerSchedules.post('/schedules/:date/:hour', scheduleController.findByScheduleDateId);

routerSchedules.get('/schedules/:rageDays', scheduleController.countSchedules);
