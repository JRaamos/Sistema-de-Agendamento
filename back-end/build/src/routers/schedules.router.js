...
routerSchedules.post('/schedules/:date/:hour', schedules_controller_1.default.findByScheduleDateId);
routerSchedules.get('/schedules/:rageDays', schedules_controller_1.default.countSchedules);
